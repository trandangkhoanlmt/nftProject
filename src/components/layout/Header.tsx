...
export function Header({
  ...
  const cawUsdtData = async () => {
    return await axios
      .get(
        "https://api.coingecko.com/api/v3/simple/price?ids=a-hunters-dream,ethereum&vs_currencies=usd"
      )
  ...
  return (
    ...
    >
        ...
        <Grid container spacing={0}>
            ...
            >
              <Tooltip title={toFixed(cawUsdt) + "$"}>
                <Box sx={{ ...TOKEN, marginRight: "30px" }}>
                  ...
                  <Typography
                    variant="h6"
                    sx={{ ...COIN_PRICE, color: mainTextColor }}
                    noWrap
                  >
                    CAW :{" " + (cawUsd?.[0] + ".0")}
              ...
              <Box sx={TOKEN}>
                ...
                <Typography
                  ...
                  noWrap
                >
                  ETH :{" " + (prices as unknown as any)?.["ethereum"]?.usd}$
                </Typography>
              </Box>
            </Box>
          ...
          <Grid item sx={BUTTON_GROUP} xs={4}>
            ...
            >
              <Link to="/caw-direct">
                <img
                  style={{ marginTop: "7px", width: "30px", height: "30px" }}
      ...
      <DrawerBar
        ...
        state={state}
        colorChange={colorMode.toggleColorMode}
        theme={theme}
